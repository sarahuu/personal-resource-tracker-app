import { BarChart2, GlassWater, PowerIcon, Menu } from "lucide-react";
...
const SIDEBAR_ITEMS = [
    ...
    {name:"Water Logs", icon:GlassWater, color:"#3B82F6", href:"/water-logs"},
    {name:"Energy Logs", icon:PowerIcon, color:"#6EE787", href:"/energy-logs"}
]
const Sidebar = () => {
